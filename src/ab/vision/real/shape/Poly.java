...
public class Poly extends Body {
  ...
  public Poly(ArrayList<LineSegment> lines, int left, int top, ABType type,
      double xs, double ys) {
    polygon = new Polygon();
    shape = ABShape.Poly;
    if (lines != null) {
    ...
    _shiftar = ABUtil.resize(polygon);
  }
  ...
  public String toString() {
    return String.format(
        "Poly: id:%d type:%s hollow:%b %dpts at x:%3.1f y:%3.1f", id, type,
        hollow, polygon.npoints, centerX, centerY);
  }
}
