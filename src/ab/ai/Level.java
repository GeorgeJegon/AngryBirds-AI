...
public class Level {
	...
	public Level(int id, int number_of_pigs, int number_of_birds,
		...
		this.max_score_avaliable = 10000
				* (this.number_of_tnts + this.number_of_birds - 1) + 5000
	...
	public String toString() {
		return String
				.format("Level [id:%d, max_score_avaliable: %d ,number_of_birds: %d, number_of_blocks: %d, "
						+ "number_of_pigs: %d, number_of_tnts: %d]",
						this.getId(), this.getMax_score_avaliable(),
						this.getNumber_of_birds(), this.getNumber_of_blocks(),
						this.getNumber_of_pigs(), this.getNumber_of_tnts());
	}
}
